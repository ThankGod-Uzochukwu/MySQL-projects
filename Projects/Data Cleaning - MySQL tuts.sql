...
-- always cross check duplicates before removing them.
...
-- to delete the layoffs_staging table
...
-- changing/formatting text date to the normal date style/appearance.
SELECT `date`,
